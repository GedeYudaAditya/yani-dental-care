...
class MedicalRecordController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validationData = $request->validate([
            ...
            'penyakit_jantung' => 'nullable',
            'haemophilia' => 'nullable',
            'diabetes' => 'nullable',
            'hepatitis' => 'nullable',
            'penyakit_lain' => 'nullable',
        ...
        try {
            ...
            $record = MedicalRecord::create([
                ...
                'penyakit_jantung' => ($request->penyakit_jantung == null ? 'tidak' : $request->penyakit_jantung),
                'haemophilia' => ($request->haemophilia == null ? 'tidak' : $request->haemophilia),
                'diabetes' => ($request->diabetes == null ? 'tidak' : $request->diabetes),
                'hepatitis' => ($request->hepatitis == null ? 'tidak' : $request->hepatitis),
