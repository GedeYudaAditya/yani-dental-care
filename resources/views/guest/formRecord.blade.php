        ...
        @if ($judul == 'Tambah Medical Record')
            <form id="sectionForm" action="{{ route('guest.medical-record.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="tab col-md-6">Pilih Pasien: <span class="text-danger">*</span>
                        <p>
                            @isset($record)
                        ...
                        <p>Centang jika pasien memiliki beberapa penyakit berikut:</p>
                        <div class="mx-3">
                            <div class="row mb-3">
                                ...
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch"
                                        name="penyakit_jantung" value="ya">
                                ...
                                {{-- check box --}}
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch" name="haemophilia"
                                        value="ya">

                                    <label for="Haemophilia" class="form-check-label">Haemophilia</label>
                                </div>
                                ...
                                {{-- check box --}}
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch" name="diabetes"
                                        value="ya">
                                ...
                                {{-- check box --}}
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch" name="hepatitis"
                                        value="ya">
                        ...
                        Alergi (Kosongkan jika tidak ada alergi)
                    ...
                    <div class="tab col-md-6">
                        <p>
                            ...
                            <input type="text" placeholder="Angka Gigi..." oninput="this.className = ''"
                                name="gigi" id="nomor_gigi" disabled readonly>
                        </p>
                        ...
                        <p>
                            Radiologi (menerima: jpeg, png, jpg, gif)
                            <input type="file" placeholder="File Radiologi..." oninput="this.className = ''"
                                accept=".jpeg, .png, .jpg, .gif" name="radiologi">
                        </p>
                        <p>
                ...
                <div class="row">
                        ...
                        <div class="mx-3">
                            <div class="row mb-3">
                                ...
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch"
                                        name="penyakit_jantung" value="ya"
                                        {{ $patien->penyakit_jantung == 'ya' ? 'checked' : '' }}>
                                    <label for="Jantung" class="form-check-label">Jantung</label>
                                </div>
                                ...
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch" name="haemophilia"
                                        value="ya" {{ $patien->haemophilia == 'ya' ? 'checked' : '' }}>
                                ...
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch" name="diabetes"
                                        value="ya" {{ $patien->diabetes == 'ya' ? 'checked' : '' }}>
                                ...
                                <div class="form-check col-md-3">
                                    <input type="checkbox" class="form-check-input" role="switch" name="hepatitis"
                                        value="ya" {{ $patien->hepatitis == 'ya' ? 'checked' : '' }}>
                    ...
                    <div class="tab col-md-6">
                        ...
                        <p>
                            ...
                            <input type="file" placeholder="File Radiologi..." oninput="this.className = ''"
                                accept="jpeg, png, jpg, gif" name="radiologi"
                                value="{{ $patien->radiology[0]->image }}">
                        </p>
                        <p>
                            Dokumen (menerima: pdf, doc, docx)
                            <input type="file" placeholder="File Radiologi..." oninput="this.className = ''"
