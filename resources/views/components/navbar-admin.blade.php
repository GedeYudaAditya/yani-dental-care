...
<header class="navbar navbar-expand-md navbar-dark navbar-overlap d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
                <img src="{{ asset('/static') }}/AYANI.png" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <a href="{{ route('admin.edit-user', auth()->user()->id) }}" class="dropdown-item">Profile</a>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ Route::is('admin.data-user') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Route::is('admin.manage-web') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.manage-web') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <li class="nav-item {{ Route::is('admin.backup-restore') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.backup-restore') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
